...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        {
            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(new DateTime(2011, 2, 5), new DateTime(2011, 2, 7), 500);
            var remainingFlight = new Flight(new DateTime(2011, 3, 6), new DateTime(2011, 3, 9), 450);
